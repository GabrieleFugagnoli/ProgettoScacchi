...
class Partita{
    ...
    public:
    //void move(punto di partenza, punto di arrivo) considera la legalita' (compreso lo scacco), chiamera' anche isLegal e poi fara' il test con la board di prova, se legale fara' la mossa
